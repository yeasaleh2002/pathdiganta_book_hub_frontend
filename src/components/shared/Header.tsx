...
import { Search, Heart, ShoppingCart, User, PhoneCall, Truck } from "lucide-react";
      ...
      <div className={`w-full bg-white dark:bg-gray-900 transition-all duration-300 border-b border-gray-200 dark:border-gray-800 ${
        ...
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            {mounted && isLoggedIn ? (
              <Link href="/dashboard" className="hidden sm:flex items-center gap-2 p-2 px-4 bg-gray-100 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700 text-gray-900 dark:text-white font-bold rounded-full transition-colors shadow-sm border border-gray-200 dark:border-gray-700">
                <User size={18} /> <span className="text-sm">Dashboard</span>
              </Link>
            ) : mounted ? (
