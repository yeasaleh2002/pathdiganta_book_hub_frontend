...
function VerifyOtpContent() {
  ...
  return (
    <div className="min-h-screen flex w-full bg-white dark:bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 py-12 sm:p-12 lg:p-24 animate-in fade-in slide-in-from-right-8 duration-700">
            ...
            <>
              <div className="mb-10">
                <div className="inline-flex items-center gap-2 px-3 py-1.5 bg-blue-50 dark:bg-blue-900/20 rounded-full mb-6">
                  ...
                  <span className="text-xs font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest">{t("emailVerif")}</span>
                </div>
              ...
              <div className="mt-8 text-center">
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                  ...
                  >
                    {isResending
                      ? <><RefreshCw size={13} className="animate-spin" /> {t("sending")}</>
                      : resendCooldown > 0
