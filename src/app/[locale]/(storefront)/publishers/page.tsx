      ...
      <div className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 shadow-sm relative z-10">
        <div className="max-w-7xl mx-auto px-4 py-8 md:py-12 flex flex-col md:flex-row gap-6 justify-between items-start md:items-center">
          ...
          <div className="w-full md:w-auto relative max-w-sm">
             <input type="text" placeholder={t("searchPublishers")} className="w-full pl-4 pr-4 py-3 rounded-xl border border-gray-300 dark:border-gray-700 focus:border-purple-500 bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-purple-500/20 transition-all" />
          </div>
        </div>
      </div>
