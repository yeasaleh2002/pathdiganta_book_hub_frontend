...
import { UploadCloud, X, Loader2, Save, AlertCircle, ArrowLeft } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast.success("Success: Book structurally modified and deployed to global catalog.");
